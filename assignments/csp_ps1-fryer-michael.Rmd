...
\textit{ChatGPT was used to help understand how to write R code. Specifically for question 3, ChatGPT was used to understand how broadcasting operations works. This was useful for both the analytical solution (omitted from the pdf) and for the numeric solution. Aside from those cases, ChatGPT was not used in this assignment.}

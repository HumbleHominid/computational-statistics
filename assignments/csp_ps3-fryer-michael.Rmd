...
\textit{The coin in part \textbf{a)} has a higher entropy than the coin in \textbf{b)}. The variance in the probabilities in \textbf{b)} is larger than in \textbf{a)} i.e. the more unique events there are with similar probabilities of occurring, the larger the entropy will be.}
